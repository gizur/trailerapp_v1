...
public class ListViewDialog implements OnItemClickListener {
	...
	public ListViewDialog(Activity activity, int layoutid, String title, ArrayList<String> values, int activityID)
	{
		...
		ArrayAdapter<String> adapter = new ArrayAdapter<String>(activity, android.R.layout.simple_list_item_single_choice, values);
